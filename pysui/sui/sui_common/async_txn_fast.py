...
class AsyncSuiTransaction(txbase):
    ...
    async def move_call_cache(
        self,
        *,
        target: str,
        arguments: list[Any],
        type_arguments: Optional[list] = None,
        function_meta_args: Optional[tuple] = None,
    ) -> Union[bcs.Argument, list[bcs.Argument]]:
        ...
        if function_meta_args:
            package, package_module, package_function, retcount, ars = function_meta_args
        else:
            package, package_module, package_function, retcount, ars = (
